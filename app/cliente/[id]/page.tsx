                                    ...
                                    <div className="relative z-10">
                                        ...
                                        <div className="flex items-center justify-between mt-6 pt-4 border-t border-slate-100 text-sm">
                                            <p className="text-slate-500 font-medium flex items-center">
                                                ...
                                                {new Date(prestamo.fechaInicio).toLocaleDateString('es-PE', { month: 'short', day: 'numeric', year: 'numeric' })}
                                            </p>
                                        ...
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-xs text-slate-400 font-medium">
                                                    {new Date(prestamo.fechaInicio).toLocaleDateString('es-PE', { month: 'long', day: 'numeric', year: 'numeric' })}
                                                </p>
                                            </div>
                                        </div>
                                    </div>
